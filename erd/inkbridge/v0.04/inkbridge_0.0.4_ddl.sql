...
(
    ...
    `accumulation_rate_policy_id` BIGINT       NOT NULL,
    ...
    CONSTRAINT `book_order_delivery_policy_fk` FOREIGN KEY (`delivery_policy_id`) REFERENCES `delivery_policy` (`delivery_policy_id`),
    CONSTRAINT `book_order_accumulation_rate_policy_fk` FOREIGN KEY (`accumulation_rate_policy_id`) REFERENCES `accumulation_rate_policy` (`accumulation_rate_policy_id`)
);
